...
public function fmcgconfirm_order(){
        return view('fmcgorder');
        }


    public function fmcgorder(Request $request){
        $member= Auth::user()->id;
 ...
 public function fmcgredirectToGateway()
    {
        try{
     ...
     * @return void
     */
    public function fmcghandleGatewayCallback()
    {
