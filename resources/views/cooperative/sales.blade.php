            ...
            <div class="row g-2 align-items-center">
                  ...
                  <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                              ...
                              <a href="{{ url('add_new_product') }}" class="btn btn-danger d-none d-sm-inline-block">
                              ...
                              <a href="{{ url('add_new_product') }}" class="btn btn-danger d-sm-none btn-icon"
                                    aria-label="product">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                          viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                ...
                                                <div class="row align-items-center">
                                                      ...
                                                      <div class="col">
                                                            <div class="font-weight-medium">
                                                                  {{ number_format($sumSales->sum('seller_price')) }}
                                                                  Sales
                                                            </div>
                                                ...
                                                <div class="row align-items-center">
                                                      ...
                                                      <div class="col">
                                                            <div class="font-weight-medium">
                                                                  ...
                                                                  {{ $countMyCustomerOrder->count() }} Customer
                                                                  Order(s)
                                                            </div>
                        ...
                        <div class="card">
                                    ...
                                    <div class="d-flex">
                                          ...
                                          <div class="ms-auto text-secondary">
                                                ...
                                                <div class="ms-2 d-inline-block">
                                                      ...
                                                      <form action="/admin-sales" method="GET" role="search">
                                                            {{ csrf_field() }}
                                          ...
                                          <tbody>
                                                ...
                                                <tr>
                                                      ...
                                                      <td><span class="text-secondary">
                                                                  {{ date('m/d/Y', strtotime($sale->created_at))}}</span>
                                                      </td>
                                                      ...
                                                      <td>{{ number_format($sale->seller_price) }}</td>
                                                      <td>@php
                                                            $total = 0;
                                                            @endphp
                                                            @php
                                                            $total += $sale->seller_price * $sale->order_quantity
                                                            @endphp
                                                            {{ number_format($total ) }}
                                                      </td>
                                                      ...
                                                      <td class="">
                                                            @if($sale->status =='paid')
                                                            <span class="badge bg-green-lt">{{$sale->status}}</span>
                                                            @endif
                                                            ...
                                                            <span class="dropdown">
                                                                  ...
                                                                  <div class="dropdown-menu dropdown-menu-end">
                                                                        <a class="dropdown-item"
                                                                              href="invoice/{{ $sale->order_number }}">
                                                                              Customer Invoice
                                                                        </a>

                                                                        @if(empty($sale->delivery_status) &&
                                                                        $sale->status =='paid')
                                                                        @csrf
                                                                        <form action="{{ url('order-delivery') }}/{{ $sale->id}}/{{ $sale->product_id}}"
                                                                              method="POST">
                                                                              @csrf
                              ...
                              <div class="card-footer d-flex align-items-center">
                                    <p class="m-0 text-secondary">
                                          ...
                                          Showing {{ ($sales->currentPage() - 1) * $sales->perPage() + 1; }} to
                                    ...
                                    <ul class="pagination m-0 ms-auto">
                                          ...
                                          <li class="page-item"> {{ $sales->appends(compact('perPage'))->links()  }}
                                          </li>
