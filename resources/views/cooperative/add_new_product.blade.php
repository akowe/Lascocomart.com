...
<div class="adminx-content">
      ...
      <div class="adminx-main-content">
            <div class="container-fluid">
                  ...
                  <div class="pb-3">
                        <p class="text-danger">"Note that LascocoMart percentage would be added to each product on
                              our landing page. <br>We assume your prices are wholesale and reasonable." Image
                              format: <span class="text-dark">.jpg, .png, .jpeg.</span> Max size: <span
                                    class="text-dark">300kb.</span>
                              <!-- Max-dimension: <span class="text-dark">600 x 600</span> -->
                        </p>
                        <h6 class="navbar bg-dark text-white" style="padding-left: 10px;">
                              Note that all uploaded products would be review and approve by
                              LascocoMart before it becomes
                              visible. This is within 48hours.
                        </h6>
                        <p>
                  ...
                  <div class="row">
                        <div class="col-lg-12 ">
                              ...
                              <form enctype="multipart/form-data" action="{{ url('coopupload-image') }}" method="POST">
                                    <div class="row">
                                          <div class="col-lg-3 ">
                                                @csrf
                                          ...
                                          <div class="col-lg-3">
                                                ...
                                                <div class="form-group">
                                                      <lablel>Upload more images <i
                                                                  class="text-danger">(Optional)</i></label>
