               ...
               <div class="col-lg-4">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">View all members</p>
                       <a href="{{ route('members')}}" class="btn btn-danger">View</a>
                ...
                <div class="card">
                  ...
                  <div class="card-body collapse show tabel-resposive" id="card">
                    ...
                    <table class="table-striped table">
                        ...
                        <tbody>
                          @foreach($fcmgproduct as $product)
                             ...
                             <!-- <td class="text-danger">
                              <a href="" data-toggle="modal" data-target="#pModal" class="btn btn-outline-danger btn-sm"> 
                                ...
                                <td>
                                    ...
                                    <form action="/fcmgremove_product" method="post" name="submit">
                                    @csrf
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">Note that all uploaded products would be review and approve by CoopMart before it becomes visible. This is within 48hours.</p>
                       <a href="{{ route('fcmgproduct') }}" class="btn btn-danger">Add Products</a>
