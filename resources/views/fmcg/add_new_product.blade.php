      ...
      <div class="container-xl">
            <div class="row g-2 align-items-center">
                  ...
                  <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                              <a href="{{ url('fmcg-products') }}" class="btn btn-danger d-none d-sm-inline-block">
                              ...
                              <a href="{{ url('fmcg-products') }}" class="btn btn-danger d-sm-none btn-icon"
                                    aria-label="product">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye"
                                          width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5"
      ...
      <div class="container-xl">
            ...
            <div class="row row-cards">
                  <div class="col-12">
                        ...
                        <form class="card" enctype="multipart/form-data" action="{{ url('fmcg-add-product') }}"
                              method="POST">
                              @csrf
                              <div class="card-body">
                                    <div class="row">
