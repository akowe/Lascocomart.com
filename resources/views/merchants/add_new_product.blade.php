      ...
      <div class="adminx-main-content">
            <div class="container-fluid">
                  ...
                  <div class="pb-3">
                        ...
                        <p class="text-danger">"Note that LascocoMart percentage would be added to each product on our
                              landing page. <br>We assume your prices are wholesale and reasonable." Image format: <span
                                    class="text-dark">.jpg, .png, .jpeg.</span> Max size: <span
                              ...
                              <form enctype="multipart/form-data" action="{{ url('upload-image') }}" method="POST">
                                    <div class="row">
                                          ...
                                          <div class="col-lg-6">
                                                ...
                                                <!-- <div class="form-group">
                                                      <p> <input type="checkbox" required> I agree to receive payment
                                                            for products within 1 to 14 days after successful delivery
                                                            to the cooperative/member</p>
                                                </div> -->
