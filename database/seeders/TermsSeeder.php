...
class TermsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Terms::create(
        [
            'terms_c'     => 'These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and [coopmart.ng] (“we,” “us” or “our”), concerning your access to and use of the [coopmart.ng] website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). 
...
Unless otherwise indicated, the Site is our proprietary property and all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Site (collectively, the “Content”) and the trademarks, service marks, and logos contained therein (the “Marks”) are owned or controlled by us or licensed to us, and are protected by copyright and trademark laws and various other intellectual property rights and unfair competition laws of the Republic of Nigeria, foreign jurisdictions, and international conventions. 
...
These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of the State, applicable to agreements made and to be entirely performed within the State/Commonwealth of the state, without regard to its conflict of law principles. 
